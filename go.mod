module github.com/ArjenSchwarz/fog
...
// replace github.com/ArjenSchwarz/go-output => ../go-output

require (
	github.com/ArjenSchwarz/go-output v0.0.0-20220531123422-c1c337cad5e7
